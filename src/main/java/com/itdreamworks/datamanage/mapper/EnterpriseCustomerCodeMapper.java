...
import com.itdreamworks.datamanage.entity.db.EnterpriseCustomerCode;
...
public interface EnterpriseCustomerCodeMapper {
    ...
    @Select("select c.Id,c.Code,e.CustomerName,p.Status from EnterpriseCustomerCode as c inner join  EnterpriseCode as p on p.CodePrefix = c.CodePrefix inner join EnterpriseCustomer as e on e.Id = c.EnterpriseCustomerId where c.EnterpriseCustomerId={enterpriseCustomerId}")
